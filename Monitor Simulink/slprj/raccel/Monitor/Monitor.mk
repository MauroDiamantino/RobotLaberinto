...
MODEL               = Monitor
MODULES             = rt_matrx.c rt_printf.c rt_logging.c Monitor_capi.c Monitor_data.c Monitor_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c
MAKEFILE            = Monitor.mk
...
MASTER_ANCHOR_DIR   = 
START_DIR           = E:/Usuarios/Mauro/Documentos/RobotLaberinto/Monitor Simulink
...
MODELLIB                  = Monitorlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Monitor_ref.rsp
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	...
	-I$(START_DIR)/slprj/raccel/Monitor \
...
ifeq ($(MODEL_HAS_DYNAMICALLY_LOADED_SFCNS), 1)
  MATLIBS += $(MATLAB_ROOT)\extern\lib\win64\lcc\libmwsl_sfcn_loader.lib
endif
